            ...
            <form onSubmit={handleVerifyCode} className="space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-400 focus:outline-none transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500"
                  required
                />
              </div>
              {error && (
