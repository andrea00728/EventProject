                ...
                <div className="p-6 relative">
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-100">
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2 px-6 py-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg text-sm"
