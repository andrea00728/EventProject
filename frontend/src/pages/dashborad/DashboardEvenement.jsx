    ...
    return (
        <div className="min-h-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
                ...
                <div className="px-4 sm:px-6 md:px-8 py-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4 mt-4 sm:mt-0">
                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-4 sm:px-6 py-2 rounded-full text-sm font-medium">
            ...
            <div className="px-4 sm:px-6 md:px-8 py-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
                        <div className="relative flex-1 w-full sm:max-w-md">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                                value={searchTerm}
                                onChange={(e) => setSearchTerm(e.target.value)}
                            />
                        </div>
                        <button className="flex items-center space-x-2 px-4 py-3 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors w-full sm:w-auto">
                ...
                {error && (
                    <div className="bg-gradient-to-r from-red-50 to-pink-50 border-2 border-red-200 rounded-2xl p-4 sm:p-6 mb-8 shadow-lg">
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full">
                                <thead className="bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50">
                                    <tr>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider">Événement</th>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider">Date</th>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider hidden sm:table-cell">Lieu</th>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider hidden md:table-cell">Invités</th>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider hidden lg:table-cell">Personnel</th>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-left text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider hidden md:table-cell">Statut</th>
                                        <th className="px-4 sm:px-8 py-4 sm:py-6 text-center text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr key={event.id} className="hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-purple-50/50 transition-all duration-300 group">
                                                <td className="px-4 sm:px-8 py-4 sm:py-6">
                                                    <div className="flex items-center space-x-4">
                                                        <div>
                                                            <div className="text-base sm:text-xl font-bold text-gray-900 group-hover:text-indigo-700 transition-colors">{event.nom}</div>
                                                ...
                                                <td className="px-4 sm:px-8 py-4 sm:py-6 hidden md:table-cell">
                                                    <span className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl text-xs sm:text-sm font-bold shadow-lg ${getEventStatutColor(event.statut)}`}>
                                                        {event.statut}
                                                    </span>
                                                </td>
                                ...
                                <div key={event.id} className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:rotate-1 group overflow-hidden">
                                    ...
                                    <div className="relative p-4 sm:p-6 lg:p-8">
                                        <div className="flex items-center justify-between mb-4 sm:mb-6">
                                            <div className="flex-shrink-0 w-12 sm:w-16 h-12 sm:h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-xl group-hover:shadow-2xl transition-all duration-300 group-hover:scale-110">
                                                <Calendar className="w-6 sm:w-8 h-6 sm:h-8 text-white" />
                                            </div>
                                            <span className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl text-xs font-bold shadow-xl ${getEventStatutColor(event.statut)}`}>
                                                {event.statut}
                                            </span>
                                        </div>

                                        <h3 className="text-lg sm:text-2xl font-bold text-gray-900 mb-4 group-hover:text-indigo-700 transition-colors">{event.nom}</h3>

                                        <div className="space-y-4 mb-6 sm:mb-8">
                                            <div className="flex items-center text-gray-600 bg-gray-50 rounded-2xl p-3">
                                                <Clock className="w-4 sm:w-5 h-4 sm:h-5 mr-3 text-indigo-500" />
                                                <span className="font-medium text-sm sm:text-base">{new Date(event.date).toLocaleDateString('fr-FR')}</span>
                                            </div>

                                            <div className="flex items-center text-gray-600 bg-gray-50 rounded-2xl p-3">
                                                <House className="w-4 sm:w-5 h-4 sm:h-5 mr-3 text-purple-500" />
                                        ...
                                        <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                                            <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border-2 border-blue-100 shadow-lg">
                                                <div className="text-2xl sm:text-3xl font-bold text-blue-600 mb-2">{inviteCounts[event.id] || 0}</div>
                                            ...
                                            <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border-2 border-purple-100 shadow-lg">
                                                <div className="text-2xl sm:text-3xl font-bold text-purple-600 mb-2">{personnelData.total}</div>
                                        ...
                                        <button
                                            onClick={() => openEventModal(event)}
                                            className="w-full flex items-center justify-center px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-indigo-500 via-purple-600 to-pink-600 hover:from-indigo-600 hover:via-purple-700 hover:to-pink-700 text-white font-bold rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl text-xs sm:text-sm"
                                        >
                                            <Eye className="w-4 sm:w-5 h-4 sm:h-5 mr-3" />
                                            Voir les détails
            ...
            {modalOpen && selectedEvent && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-xl flex items-center justify-center p-4 sm:p-6 z-50 animate-in fade-in duration-300">
                    <div className="bg-white/95 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/20 w-full max-w-full sm:max-w-4xl lg:max-w-7xl max-h-[90vh] sm:max-h-[95vh] overflow-hidden animate-in zoom-in-95 duration-300">
                        {/* En-tête du modal premium avec glassmorphism */}
                        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
                            ...
                            <div className="relative flex justify-between items-start text-white">
                                <div className="flex flex-col space-y-4">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                                        {selectedEvent.nom}
                                    </h3>
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-6 lg:space-x-8 text-blue-100/90">
                                ...
                                <button
                                    onClick={closeModal}
                                    className="p-2 sm:p-3 hover:bg-white/20 rounded-2xl transition-all duration-200 border border-white/20 backdrop-blur-sm group"
                                >
                        ...
                        <div className="overflow-y-auto max-h-[calc(90vh-140px)] sm:max-h-[calc(95vh-140px)]">
                            {/* Navigation des onglets moderne */}
                            <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-gradient-to-b from-gray-50/80 to-white border-b border-gray-100">
                                <nav className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 bg-gray-100/60 p-1.5 rounded-2xl backdrop-blur-sm">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center space-x-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl text-xs sm:text-sm font-semibold transition-all duration-300 relative group ${activeTab === tab.id
                                        ...
                                        >
                                            ...
                                            <span>{tab.label}</span>
                                            <span className={`px-2 sm:px-2.5 py-1 rounded-full text-xs font-bold transition-all ${activeTab === tab.id
                            ...
                            <div className="p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-white to-gray-50/30">
                                {isLoading && (
                                    <div className="flex items-center justify-center py-12 sm:py-16">
                                        ...
                                        <span className="text-gray-600 ml-4 font-medium text-sm sm:text-base">Chargement des données...</span>
                                    </div>
                                )}
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full">
                                                <thead className="bg-gradient-to-r from-blue-50 to-indigo-50">
                                                    <tr>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-blue-600 uppercase tracking-widest border-b border-blue-100">Nom</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-blue-600 uppercase tracking-widest border-b border-blue-100 hidden sm:table-cell">Email</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-blue-600 uppercase tracking-widest border-b border-blue-100 hidden md:table-cell">Téléphone</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {guests.map((guest, index) => (
                                                        <tr key={guest.id} className={`hover:bg-blue-50/50 transition-all duration-200 group ${index % 2 === 0 ? 'bg-white/50' : 'bg-gray-50/30'}`}>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 font-semibold text-gray-900 group-hover:text-blue-900 transition-colors">
                                                                <div className="flex items-center space-x-3">
                                                                    <div className="w-2 h-2 bg-blue-400 rounded-full group-hover:bg-blue-600 transition-colors"></div>
                                                                    <span className="text-sm sm:text-base">{guest.nom}</span>
                                                                </div>
                                                            </td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 text-gray-600 group-hover:text-gray-700 transition-colors hidden sm:table-cell text-sm sm:text-base">{guest.email}</td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 text-gray-600 group-hover:text-gray-700 transition-colors hidden md:table-cell text-sm sm:text-base">{guest.telephone}</td>
                                                        </tr>
                                                    ))}
                                                </tbody>
                                            </table>
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full">
                                                <thead className="bg-gradient-to-r from-purple-50 to-pink-50">
                                                    <tr>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-purple-600 uppercase tracking-widest border-b border-purple-100">Nom</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-purple-600 uppercase tracking-widest border-b border-purple-100 hidden sm:table-cell">Rôle</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-purple-600 uppercase tracking-widest border-b border-purple-100 hidden md:table-cell">Téléphone</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-purple-600 uppercase tracking-widest border-b border-purple-100 hidden lg:table-cell">Statut</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {personnel.map((p, index) => (
                                                        <tr key={p.id} className={`hover:bg-purple-50/50 transition-all duration-200 group ${index % 2 === 0 ? 'bg-white/50' : 'bg-gray-50/30'}`}>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 font-semibold text-gray-900 group-hover:text-purple-900 transition-colors">
                                                                <div className="flex items-center space-x-3">
                                                                    <div className="w-2 h-2 bg-purple-400 rounded-full group-hover:bg-purple-600 transition-colors"></div>
                                                                    <span className="text-sm sm:text-base">{p.nom}</span>
                                                                </div>
                                                            </td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 hidden sm:table-cell">
                                                                <span className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl text-xs font-bold bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800 border border-blue-200 shadow-sm">
                                                                    {p.role}
                                                                </span>
                                                            </td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 text-gray-600 group-hover:text-gray-700 transition-colors hidden md:table-cell text-sm sm:text-base">{p.telephone}</td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 hidden lg:table-cell">
                                                                <span className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl text-xs font-bold border shadow-sm ${getPersonnelStatutColor(p.statut)}`}>
                                                                    {p.statut}
                                                                </span>
                                                            </td>
                                                        </tr>
                                        ...
                                        <div className="overflow-x-auto">
                                            <table className="min-w-full">
                                                <thead className="bg-gradient-to-r from-emerald-50 to-green-50">
                                                    <tr>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-emerald-600 uppercase tracking-widest border-b border-emerald-100">Nom de Table</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-emerald-600 uppercase tracking-widest border-b border-emerald-100 hidden sm:table-cell">Capacité</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-emerald-600 uppercase tracking-widest border-b border-emerald-100 hidden md:table-cell">Invités</th>
                                                        <th className="px-4 sm:px-8 py-3 sm:py-5 text-left text-xs font-bold text-emerald-600 uppercase tracking-widest border-b border-emerald-100 hidden lg:table-cell">Places</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {tables.map((t, index) => (
                                                        <tr key={t.id} className={`hover:bg-emerald-50/50 transition-all duration-200 group ${index % 2 === 0 ? 'bg-white/50' : 'bg-gray-50/30'}`}>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 font-semibold text-gray-900 group-hover:text-emerald-900 transition-colors">
                                                                <div className="flex items-center space-x-3">
                                                                    <div className="w-2 h-2 bg-emerald-400 rounded-full group-hover:bg-emerald-600 transition-colors"></div>
                                                                    <span className="text-sm sm:text-base">Table {t.numero}</span>
                                                                </div>
                                                            </td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 text-gray-600 group-hover:text-gray-700 transition-colors font-medium hidden sm:table-cell text-sm sm:text-base">{t.capacite}</td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 text-gray-600 group-hover:text-gray-700 transition-colors font-medium hidden md:table-cell text-sm sm:text-base">{t.invites}</td>
                                                            <td className="px-4 sm:px-8 py-3 sm:py-5 hidden lg:table-cell">
                                                                <span className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl text-xs font-bold bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 border border-green-200 shadow-sm">
                                ...
                                {activeTab === "invites" && guests.length === 0 && !isLoading && (
                                    <div className="text-center py-12 sm:py-24">
                                        ...
                                        <h3 className="text-xl sm:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Aucun invité inscrit</h3>
                                ...
                                {activeTab === "personnel" && personnel.length === 0 && !isLoading && (
                                    <div className="text-center py-12 sm:py-24">
                                        ...
                                        <h3 className="text-xl sm:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Équipe en attente</h3>
                                ...
                                {activeTab === "tables" && tables.length === 0 && !isLoading && (
                                    <div className="text-center py-12 sm:py-24">
                                        ...
                                        <h3 className="text-xl sm:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Plan de tables vide</h3>
