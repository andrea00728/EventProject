  ...
  <div className="h-full flex flex-col">
    ...
    <div className="flex-shrink-0 mb-8">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Importer des invités</h1>
          <p className="text-gray-600">Importez vos invités en masse via un fichier CSV</p>
        </div>
      </div>
    </div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-800">Configuration de l'import</h2>
          </div>
          ...
          <div className="p-8 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-800">
                        {events.find(e => e.id === eventId)?.nom || "Sélectionner un événement"}
                      </div>
                      {eventId && (
                        <div className="text-sm text-gray-500">
                          {new Date(events.find(e => e.id === eventId)?.date).toLocaleDateString('fr-FR')}
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <div className={`w-full px-6 py-8 border-2 border-dashed rounded-xl text-center transition-all duration-200 ${
                  file 
                    ...
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                      ...
                      {file ? (
                        ...
                        <svg className="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M12 19l3-3m0 0l-3-3m0 0v8" />
                        </svg>
                      )}
                    </div>
                    <div>
                      ...
                      <div className="text-sm text-gray-500 mt-1">
                        {file ? `Taille: ${(file.size / 1024).toFixed(1)} KB` : 'Ou glissez-déposez votre fichier ici'}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex justify-end pt-4">
              <button
                ...
                className={`px-8 py-3 rounded-xl font-medium text-white transition-all duration-200 flex items-center gap-2 ${
        ...
        {message && (
          <div className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-green-800 whitespace-pre-line font-medium">{message}</div>
            </div>
          </div>
        )}

        {error && (
          <div className="mb-6 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-red-800 whitespace-pre-line font-medium">{error}</div>
            </div>
          </div>
        )}
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-200 rounded-2xl p-8">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-indigo-900 mb-3">Format CSV requis</h3>
              <p className="text-indigo-800 mb-4">Votre fichier CSV doit respecter la structure suivante :</p>
    ...
    {modalOpen && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div className="bg-white rounded-2xl shadow-2xl w-[90vw] max-w-4xl max-h-[80vh] flex flex-col">
          <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            ...
            <button
              className="w-10 h-10 bg-gray-100 hover:bg-red-100 rounded-xl flex items-center justify-center text-gray-500 hover:text-red-600 transition-all duration-200"
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        ...
                        <svg className={`w-5 h-5 ${eventId === event.id ? 'text-blue-600' : 'text-gray-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                      </div>
                      {eventId === event.id && (
                    ...
                    <div className="space-y-2">
                      <div className="font-semibold text-gray-800 line-clamp-2">{event.nom}</div>
                      <div className="text-sm text-gray-600">{new Date(event.date).toLocaleDateString('fr-FR')}</div>
                      {event.theme && (
