        ...
        async function connectSocket() {
          ...
          newSocket.on("notifRegister", (data) => {
            ...
            setNotifications((prevNotifications) => {
              // Vérifier si la notification existe déjà (par id, ou par comparaison JSON si pas d'id)
              const isDuplicate = prevNotifications.some(notif => notif.id === data.id || JSON.stringify(notif) === JSON.stringify(data));
              if (isDuplicate) {
