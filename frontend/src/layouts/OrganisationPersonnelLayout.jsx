...
export default function OrganisationPersonnelLayout() {
    const choixItems = [
        ...
        },
        {
            ...
            icon: (
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14-7l2 2-2 2m-7 6h7l-2-2 2-2M7 13l-2 2 2 2" />
                </svg>
            )
        },
        {
...
return (
  <div className="flex h-screen bg-gradient-to-br from-slate-50 to-slate-100">
    {/* Sidebar fixe */}
    <aside className="w-80 bg-white/95 backdrop-blur-sm shadow-xl border-r border-gray-200 flex-shrink-0 flex flex-col fixed h-full z-30">
      {/* Header */}
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200/50">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-bold text-amber-700 truncate">Départements</p>
      ...
      <div className="p-6 border-t border-slate-200/60 flex-shrink-0">
        <div className="bg-gradient-to-r from-slate-100 to-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs font-semibold text-slate-700 truncate">Centre d'aide</p>
              <p className="text-xs text-slate-500 truncate">Ressources RH disponibles</p>
            </div>
          </div>
        </div>
      </div>
