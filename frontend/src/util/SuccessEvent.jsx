...
import defaultImage from "../../public/vecteezy_beautiful-vintage-group-silhouette-sharing-ideas-meeting_60786770.png"
...
const SuccessEvent = () => {
  ...
  // Nouvelle fonction pour déterminer le statut de l'événement
                    ...
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent">
                        ...
                        <div className="absolute bottom-4 right-4">
                          <div
                            className={`bg-gradient-to-r ${status === "terminé" ? "from-emerald-500 to-green-600" : status === "en cours" ? "from-blue-500 to-blue-600" : "from-yellow-500 to-yellow-600"} text-white px-3 py-1.5 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-md`}
                          >
                            {status === "terminé" && (
                              <svg
