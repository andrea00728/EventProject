...
const Dem = () => {
  ...
  return (
    <>
      <section className="relative w-full min-h-screen flex flex-col xl:flex-row items-center justify-center gap-12 px-6 md:px-12 py-16 bg-gray-50">
        {/* Vidéo à gauche */}
        {showVideo && (
            <div className="relative w-full xl:w-1/2 rounded-2xl overflow-hidden shadow-2xl">
                <video
                    ref={videoRef}
                    src={tutorialVideo}
                    autoPlay
