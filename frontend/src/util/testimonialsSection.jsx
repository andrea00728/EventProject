    ...
    const renderStars = (currentRating, interactive = false) => {
        return [...Array(5)].map((_, index) => (
            <FaStar
                ...
                className={`${interactive ? 'cursor-pointer' : ''} transition-all duration-300 transform ${index < (interactive ? (hoverRating || rating) : currentRating)
    ...
    return (
        <>
            ...
            <div className="container mx-auto max-w-6xl px-4 relative z-10">
                ...
                {/* Form */}
                <div className="mb-20">
                    <form onSubmit={handleSubmit} className="bg-white/80 backdrop-blur-xl shadow-2xl shadow-purple-500/10 rounded-3xl p-10 border border-white/20 hover:shadow-3xl hover:shadow-purple-500/15 transition-all duration-500">
                        {/* Rating Section */}
