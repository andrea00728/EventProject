...
export default function Profil() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpenProfil && (
          <div className="fixed top-0  h-screen left-0 w-screen z-50 flex justify-end items-start pr-10 pt-28 " onClick={() => setIsOpenProfil(false)}>
            <motion.div
              className=" bg-white/90 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 w-full max-w-sm transform transition-all duration-300 "
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 w-8 h-8 rounded-full bg-gray-100/80  flex items-center justify-center transition-all duration-200 cursor-pointer z-10"
              >
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col items-center mb-6">
                  <div className="relative group">
                    ...
                    <div className="relative w-24 h-24 rounded-full p-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
                      <img
                        src={userPhoto}
                        alt="Profil"
                ...
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-bold text-gray-800 mb-2 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text">
                    {userName}
                  </h2>
              ...
              {/* Decorative Elements */}
              <div className="absolute top-4 left-4 w-6 h-6 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full opacity-20" />
              <div className="absolute bottom-4 right-12 w-4 h-4 bg-gradient-to-br from-pink-400 to-red-500 rounded-full opacity-20" />
              <div className="absolute top-12 right-8 w-3 h-3 bg-gradient-to-br from-green-400 to-blue-500 rounded-full opacity-20" />
            </motion.div>
          </div>
        )
        }
        ...
        {confirmLogOut && (
          ...
          >
            ...
            <div className="absolute inset-0 h-screen flex items-center justify-center bg-black/30 backdrop-blur-sm" >
              ...
              {/* Contenu du modal */}
              <motion.div
                className="relative bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 max-w-md w-full mx-4 overflow-hidden"
              ...
              >
                {/* Header avec dégradé */}
                <div className="bg-gradient-to-r from-blue-600 to-purple-500 p-6 text-white relative">
                  <motion.button
                    onClick={() => setConfirmLogOut(false)}
                  ...
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <h2 className="text-xl font-bold text-center ml-5">Confirmation</h2>
                  </div>
                </div>
                ...
                <div className="p-8 text-center">
                  ...
                  <div className="flex gap-4 justify-center">
                    <motion.button
                      ...
                      className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-400 text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 min-w-[100px] cursor-pointer"
                    ...
                    <motion.button
                      onClick={() => setConfirmLogOut(false)}
                      className="cursor-pointer px-8 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 min-w-[100px]"
                      variants={buttonVariants}
                      whileHover="hover"
                      whileTap="tap"
                    >
