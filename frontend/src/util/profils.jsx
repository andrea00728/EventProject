...
export default function Profil() {
  ...
  useEffect(() => {
    if (!user) return;
    const photoUrl = resolvePhotoSrc(user.photo, user.email, localStorage.getItem("userPhoto"));
  ...
  const handleSubmitEdit = async (e) => {
    ...
    try {
      ...
      localStorage.removeItem("userPhoto"); // Nettoyage du cache temporaire

      setSuccessMessage("Profil mis à jour avec succès !");
      setEditFormData({ ...editFormData, photo: null, currentPassword: "", newPassword: "", confirmPassword: "" });
