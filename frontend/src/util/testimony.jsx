    ...
    return (
      <section className="relative bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20 py-24 px-4 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          {/* État sans commentaires - Design Pro */}
          <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-16 shadow-2xl border border-gray-200/50 text-center animate-fadeIn overflow-hidden">
            ...
            {/* Titre principal */}
            <h3 className="bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent text-3xl font-bold mb-6">
              Soyez le premier à partager votre expérience
            </h3>

            {/* Message principal avec style moderne */}
            <div className="max-w-2xl mx-auto mb-8">
              <p className="text-gray-600 text-lg leading-relaxed mb-4">
                Aucun témoignage n'a encore été partagé, mais nous sommes impatients de découvrir votre retour d'expérience !
              </p>
              <p className="text-gray-500 text-base">
                Votre avis nous aide à améliorer continuellement nos services et inspire d'autres organisateurs.
              </p>
            </div>

            {/* Call-to-action attractif */}
            <div className="bg-gradient-to-r from-orange-50 to-purple-50 rounded-2xl p-8 border border-orange-100/50">
              <div className="flex items-center justify-center gap-3 mb-4">
                <svg className="w-6 h-6 text-orange-500" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                </svg>
                <span className="bg-gradient-to-r from-orange-600 to-purple-600 bg-clip-text text-transparent text-xl font-semibold">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-gray-100">
                ...
                <div className="text-sm text-gray-600 font-medium">Support disponible</div>
              </div>
            </div>
          </div>
        </div>
